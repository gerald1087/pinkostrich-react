  ...
  render() {
    return (
      ...
      <div className="App">
        <Switch>
          <Route
            exact path={"/"} render={props => (<Home {...props} handleLogin={this.handleLogin} loggedIn={this.state.loggedIn} />)} />
      ...
      <Route 
          exact path={"/pinkostrich"} render={props => (<PinkOstrich {...props} user={this.state.user} loggedIn={this.state.loggedIn} />)} />
        </Switch>
